...
public class DdcmeTestContainer extends TestContainer {

    public DdcmeTestContainer() {
        super();
    ...
    public static class Common extends DdcmeTestContainer {

        public static final DdcmeTestContainer.Common INSTANCE = new DdcmeTestContainer.Common();
